...
public class SystemSettingsValidators {
    ...
    static {
        ...
        VALIDATORS.put(System.STATUS_BAR_BATTERY_STYLE, new InclusiveIntegerRangeValidator(0, 20));
        VALIDATORS.put(System.STATUS_BAR_BATTERY_TEXT_CHARGING, BOOLEAN_VALIDATOR);
	VALIDATORS.put(System.STATUS_BAR_SHOW_BATTERY_PERCENT, BOOLEAN_VALIDATOR);
    }
}
